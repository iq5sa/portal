<!-- Modal -->
<div class="modal fade" id="select_course_modal" tabindex="-1">
    <div class="modal-dialog dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">أختر كورس</h5>
                ...
                <form id="course_select_form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label for="academic_year_id" class="control-label">سنة القبول</label>
