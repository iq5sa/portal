...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-wpforms"></i> جدول رقم 2 المقبولين العراقيين حسب المراحل </h1>
            <p>جدول رقم (2) الطلبة العراقيين الموجودين في الدراسات الاولية موزعين  حسب القسم والفرع والمرحلة والجنس والعام الدراسي</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" id="filter_student_form" action="{{route('report.iraqi.by_stages.download')}}">
                    <div class="card-body">
                        @csrf
                        <div class="form-row">
