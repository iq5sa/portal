...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-wpforms"></i> جدول رقم 4 المقبولين العراقيين حسب المراحل </h1>
            <p>اعداد الطلبة العراقيين الراسبين موزعين حسب اسباب الرسوب وعلى مستوى الكلية للعام الدراسي الماضي</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" id="filter_student_form" action="{{route('report.students.failed.download')}}">
                    <div class="card-body">
                        @csrf
                        <div class="form-row">
