...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-wpforms"></i> جدول رقم 3 المقبولين العراقيين حسب محافظة السكن </h1>
            <p>جدول رقم 3 الطلبة المقبولون (المسجلون والمباشرون فعلاً) بحسب محافظة السكن والجنس والعام الدراسي</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="POST" id="filter_student_form" action="{{route('report.students.by_town.download')}}">
                    <div class="card-body">
                        @csrf
                        <div class="form-row">
