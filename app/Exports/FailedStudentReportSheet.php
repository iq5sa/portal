...
class FailedStudentReportSheet implements WithHeadings, WithTitle, WithEvents
{
    private $data;
    ...
    public function headings(): array
    {
        ...
        $headings = [
            ...
            [
                ...
                'جدول رقم (4) اعداد الطلبة العراقيين الراسبين موزعين حسب اسباب الرسوب وعلى مستوى الكلية للعام الدراسي ' . $this->academic_year->start_year . '-' . $this->academic_year->end_year,
            ],
            [
                'اسباب الرسوب',
                '',
                ...
                '',
                '',
                'الرسوب سنتين متتاليتين (ترقين القيد)',
                '',
                '',
                'المجموع',
            ],
